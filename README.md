...
Website elements are structured and written so that people with disabilities can access the content.

2. Talk about 3 different things you can do to ensure your website is accessible.

Make sure that text is scaleable.
Make sure that test is readable by text readers.
Make sure that alt attributes describe what the element is about.

3. How would you explain the concept of a variable to someone new to programming?

A variable is a container that holds data. The variable can be named anything except for reserved keywords.
The variable can contain anything that you would like to store.

4. What is the purpose of using functions in code?

Functions are used to perform tasks in code and can be re-used over and over.
